  ...
  return h(
    ...
    h(
      ...
      h('div', { className: 'modal-body' },
        ...
        h('p', null, 'Example: pick a contestant for Top 12 and get 1 point if they finish Bottom 12, or 2 points if they finish Top 12 or better. For your winner pick, receive 1 point if they place Bottom 12, 2 points if they 7-12, 3 points if the place 4-6, and so on.'),
        ...
        h('ol', null,
          ...
          h('li', null, 'Share your friend code with others and add friends to your own leaderboard. All info is saved in the URL, so bookmark the page once everyone is added to to save your and your friends\' picks.'),
